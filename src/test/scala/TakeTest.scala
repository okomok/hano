...
class TakeTest extends org.scalatest.junit.JUnit3Suite {
    ...
    def testTrivial0: Unit = {
        ...
        assertEquals(hano.util.Vector(1,2,3), hano.util.Vector.from(b))
    }
    ...
    def testThen: Unit = {
        ...
        assertEquals(hano.util.Vector(1,2,3,99), hano.util.Vector.from(b))
    }
    ...
    def testThen2: Unit = {
        ...
        assertEquals(hano.util.Vector(1,2,3,98,99), hano.util.Vector.from(b))
    }
/*
    def testThenNotEnough: Unit = {
        ...
        assertEquals(hano.util.Vector(1,2,3,4,5), hano.util.Vector.from(b))
    }
*/
    def testThenAppend: Unit = {
        ...
        assertEquals(hano.util.Vector(1,2,3,6,7,8), hano.util.Vector.from(b))
    }
    ...
    def testThenAppendThen: Unit = {
        ...
        assertEquals(hano.util.Vector(1,2,3,6,7,8,99), hano.util.Vector.from(b))
    }
