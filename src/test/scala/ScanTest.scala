...
class ScanLeftTest extends org.scalatest.junit.JUnit3Suite {
    def testTrivial: Unit = {
        ...
        val u = hano.util.Iter(5,6,8,11,15,20,26,33,41)
        val s = new java.util.ArrayList[Int]
        t.scanLeft(5)(_ + _).foreach(s.add(_))
        assertEquals(u, hano.util.Iter.from(s))
    }

    def testTrivial2: Unit = {
        val t = hano.Seq(1)
        val u = hano.util.Iter(5,6)
        val s = new java.util.ArrayList[Int]
        t.scanLeft(5)(_ + _).foreach(s.add(_))
        assertEquals(u, hano.util.Iter.from(s))
    }
    ...
    def testEmpty: Unit = {
        ...
        assertEquals(hano.util.Iter(0), hano.util.Iter.from(s))
    }

/*
    def testScanLeft1: Unit = {
        val t = hano.Seq(5,1,2,3,4,5,6,7,8)
        val u = hano.util.Iter(5,6,8,11,15,20,26,33,41, 99)
        val s = new java.util.ArrayList[Int]
    ...
    def testScan1Empty: Unit = {
        ...
        assertEquals(hano.util.Iter(99), hano.util.Iter.from(s))
    }
*/
}
...
class ScanLeft1Test extends org.scalatest.junit.JUnit3Suite {
    ...
    def testEmpty: Unit = {
        ...
        assertTrue(hano.util.Iter.from(s).isEmpty)
    }
}
