...
class ScanLeftTest extends org.scalatest.junit.JUnit3Suite {
    def testTrivial: Unit = {
        ...
        val u = hano.util.Iterable(5,6,8,11,15,20,26,33,41)
        val s = new java.util.ArrayList[Int]
        t.scanLeft(5)(_ + _).foreach(s.add(_))
        assertEquals(u, hano.util.Iterable.from(s))
    }

    def testTrivial2: Unit = {
        val t = hano.Seq(1)
        val u = hano.util.Iterable(5,6)
        val s = new java.util.ArrayList[Int]
        t.scanLeft(5)(_ + _).foreach(s.add(_))
        assertEquals(u, hano.util.Iterable.from(s))
    }
    ...
    def testEmpty: Unit = {
        ...
        assertEquals(hano.util.Iterable(0), hano.util.Iterable.from(s))
    }

/*
    def testScanLeft1: Unit = {
        val t = hano.Seq(5,1,2,3,4,5,6,7,8)
        val u = hano.util.Iterable(5,6,8,11,15,20,26,33,41, 99)
        val s = new java.util.ArrayList[Int]
    ...
    def testScanLeft1Empty: Unit = {
        val t = hano.Seq(5,1)
        val u = hano.util.Iterable(5,6, 99)
        val s = new java.util.ArrayList[Int]
        t.scanLeft1(_ + _).activate(reactor.make(_ => s.add(99), s.add(_)))
        assertEquals(u, hano.util.Iterable.from(s))
    }
    ...
    def testScan1Empty: Unit = {
        ...
        assertEquals(hano.util.Iterable(99), hano.util.Iterable.from(s))
    }
*/
}
...
class ScanLeft1Test extends org.scalatest.junit.JUnit3Suite {
    ...
    def testEmpty: Unit = {
        ...
        assertTrue(hano.util.Iterable.from(s).isEmpty)
    }
}
