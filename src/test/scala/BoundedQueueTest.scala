...
class BoundedQueueTest extends org.scalatest.junit.JUnit3Suite {

    def testTrivial {
        val rx = new hano.BoundedQueue[Int](5)
    ...
    def testOffer {
        val xs = new hano.BoundedQueue[Int](2)
    ...
    def testEmpty {
        val xs = new hano.BoundedQueue[Int](0)
        expect(false)(xs offer 2)
    }

    def testSignal {
        val ctx = hano.Context.act
        val a = new hano.BoundedQueue[Int](2, ctx)
        val b = new hano.BoundedQueue[Int](2, ctx)
    ...
    def testParallel {
        ...
        val xs = new hano.BoundedQueue[Int](100)
        suite.add(100) {
            xs offer 10
        }
        suite.add(100) {
