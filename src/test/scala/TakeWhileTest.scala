...
class TakeWhileTest extends org.scalatest.junit.JUnit3Suite {
    def testTrivial0: Unit = {
        ...
        assertEquals(hano.util.Iterable(1,2,3,4), hano.util.Iterable.from(b))
    }
    ...
    def testAll: Unit = {
        ...
        assertEquals(hano.util.Iterable(1,2,3,4,5,6), hano.util.Iterable.from(b))
    }
    ...
    def testThen: Unit = {
        ...
        assertEquals(hano.util.Iterable(1,2,3,4,99), hano.util.Iterable.from(b))
    }
    ...
    def testThen2: Unit = {
        ...
        assertEquals(hano.util.Iterable(1,2,3,4,98,99), hano.util.Iterable.from(b))
    }
    ...
    def testThenAppend: Unit = {
        ...
        assertEquals(hano.util.Iterable(1,2,3,4,5,6,7,99), hano.util.Iterable.from(b))
    }
}
